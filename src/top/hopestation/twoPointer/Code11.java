package top.hopestation.twoPointer;
...
public class Code11 {
     ...
     * @return
     */
    public static int maxArea_Mine(int[] height) {
        int maxArea = 0;
     ...
     * @return
     */
    public static int maxArea_Office(int[] height) {
        int maxArea = 0;
        //定义双指针
        int left  = 0;
